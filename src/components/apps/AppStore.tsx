...
import { ShoppingBag, Star, Download, CheckCircle2, FileText, Calculator, Terminal, Cloud, MessageSquare, Globe, Map as MapIcon, Activity, Calendar as CalendarIcon, Gamepad2, Bomb, Palette, Info, Camera, Presentation, Mail, Search, Store, Car, Type } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { cn } from '@/lib/utils';

const STORE_APPS: { id: AppId; name: string; description: string; category: string; rating: number; icon: any }[] = [
  { id: 'go', name: 'Nebula Go', description: 'Automotive virtualization and navigation suite.', category: 'Lifestyle', rating: 5.0, icon: Car },
  ...
  { id: 'docs', name: 'Nebula Docs', description: 'Professional cloud-synced word processor.', category: 'Productivity', rating: 4.9, icon: Type },
