'use server';
/**
 * @fileOverview An AI assistant flow that suggests relevant Google products or applications
...
const SuggestGoogleProductOutputSchema = z.object({
  suggestions: z
    .array(
      z.object({
        name: z.string().describe('The name of the suggested Google product or application.'),
        description: z
          .string()
    ...
    .describe('A list of suggested Google products or applications.'),
  explanation: z
    .string()
    .optional()
...
- Google Photos: For organizing and sharing photos and videos.
